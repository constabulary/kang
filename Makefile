...
.kang/bootstrap/github.com/constabulary/kang/cmd/kang.a: .kang/bootstrap/github.com/constabulary/kang.a cmd/kang/main.go cmd/kang/kangfile.go
	mkdir -p .kang/bootstrap/github.com/constabulary/kang/cmd/
	go tool compile -o $@ -p github.com/constabular/cmd/kang -complete -I .kang/bootstrap -pack cmd/kang/main.go cmd/kang/kangfile.go
